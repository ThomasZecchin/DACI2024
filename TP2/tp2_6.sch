...
N 2730 -970 2730 -900 {
lab=GND}
N 2530 -1060 2590 -1060 {
lab=Vout}
N 2590 -1110 2590 -1060 {
lab=Vout}
N 2570 -1110 2590 -1110 {
lab=Vout}
N 2480 -1110 2530 -1110 {
lab=vss}
...
C {lab_wire.sym} 2200 -960 2 0 {name=l23 sig_type=std_logic lab=vbn}
...
C {lab_wire.sym} 2530 -1010 2 0 {name=l11 sig_type=std_logic lab=vout}
...
C {sky130_fd_pr/pfet_01v8.sym} 2550 -1110 2 0 {name=M2
L=0.35
W=\{wp\}
nf=1
mult=1
...
C {lab_pin.sym} 2480 -1110 0 0 {name=l9 sig_type=std_logic lab=vss}
C {ngspice_get_value.sym} 2610 -1110 0 0 {name=r9 node=@M.XM2.msky130_fd_pr__pfet_01v8[gm]
descr="gm_M2="}
